...
// const getData = () => {
//        let newData= obj.filter((person)=>person.height > 150)
//        console.log(newData);
...
//         console.log(person);
//         break;  // Elementi tapdıqdan sonra döngünü dayandırırıq
//       }
//     }
//   }
...
// const getage=()=>{
    //        let result= obj.reduce((a,b)=> a += b.age,0);
    //         console.log(result);
...
// 4) sortdan isdifade ederek azalandan artan yasa qeder arraydeki elementleri sirallayan func yazin
 // function azalandanArtanaYasaGoreSirala() {
    //     obj.sort((a, b) => b.age - a.age);
    //     console.log("Yaşa görə sıralanmış istifadəçilər:", obj);
    //   }
      
    
      
    //   azalandanArtanaYasaGoreSirala();
...
// function secVeLoglaWebDeveloperlari() {
//     for (var i = 0; i < obj.length; i++) {
//       if (obj[i].company.title === "Web Developer") {
//         console.log(obj[i]);
//       }
//     }
//   }
